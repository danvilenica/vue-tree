 ...
 * @param { TreeViewNode } treeModel A Ref to the model from which traversals should start
 * @returns Methods for traversing tree nodes
 */
export function useTraversal(treeModel) {
   ...
   * @param nodeActionCallback {function} The action to call against each node, taking that node as a parameter
   * @param depthFirst {boolean} True to search depth-first, false for breadth-first.
   */
